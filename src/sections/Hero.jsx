...
import {statistics , shoes} from "../assets/constans/index.js";
import {bigShoe1} from "../assets/images";
import ShoeCard from "../components/ShoeCard.jsx";
const Hero = () => {
    const [bigShoeImg, setBigShoe] = React.useState(bigShoe1);
    return (
       <section
       id="home"
       className="w-full flex flex-col
        ...
        <p className="text-xl font-montserrat
         text-coral-red">Our Autumn Collection
        </p>
        <h1 className="font-palanquin mt-10 font-bold
        ...
        <p className="font-montserrat
         text-slate-gray text-lg leading-8 mt-6
          mb-14 sm:max-w-sm">Discover our new arrivals</p>
            <Button label = "Start shopping" icon = {arrowRight} />

            <div className="flex justify-start
            items-start flex-wrap w-full mt-20 gap-16">
                {statistics.map((stat, num)=>(
           ...
           <div className="relative flex-1
            ...
            bg-hero bg-cover bg-center">
               ...
               -bottom-[5%] sm:left-[25%] msx-sm:px-6">
                   {shoes.map((shoe)=>(
                       <div key = {shoe}>
                           <ShoeCard img = {shoe}
                           changeBigShoeImage = { (shoes)=> setBigShoe(shoes) }
